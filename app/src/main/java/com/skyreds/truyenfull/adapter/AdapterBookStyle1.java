...
public class AdapterBookStyle1 extends RecyclerView.Adapter<AdapterBookStyle1.ViewHolder>{

    private final List<HotBook> lst;
    private final Context mContext;

    public AdapterBookStyle1(Context context, List<HotBook> comicList) {
        this.lst = comicList;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.row_style1, parent, false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ViewHolder(View itemView) {
            ...
            thumbnail = itemView.findViewById(R.id.img_book);
        }
    }
